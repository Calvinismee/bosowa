...
<head>
    ...
    <title>Edit Biaya Tambahan - Taksi App</title>
    ...
    <nav class="navbar navbar-dark navbar-custom mb-4">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h5">
                <i class="fas fa-taxi"></i> Taksi App - Edit Biaya Tambahan
            </span>
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-md-8 offset-md-2">
                <h3>Edit Biaya Tambahan Transaksi #<?= $id ?></h3>
                <p class="text-muted">Ubah atau kelola biaya tambahan yang sudah ditambahkan</p>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <div class="mt-3">
                    <a href="edit.php?id=<?= $id ?>" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Kembali ke Edit Transaksi
                    </a>
